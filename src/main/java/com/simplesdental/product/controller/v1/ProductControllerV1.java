...
@Tag(name = "Produtos v1", description = "API versão 1 - Código em formato PROD-001")
public class ProductControllerV1 {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista de produtos retornada com sucesso",
                    content = @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = ProductV1.class)))),
    ...
    public ResponseEntity<Page<ProductV1>> getAllProducts(
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Produto encontrado",
                    content = @Content(schema = @Schema(implementation = ProductV1.class))),
            @ApiResponse(
                    responseCode = "403",
    ...
    public ProductV1 createProduct(@Valid @RequestBody ProductV1 product) {
    ...
    @PutMapping("/{id}")
    @SecurityRequirement(name = "bearerAuth")
    public ResponseEntity<ProductV1> updateProduct(@PathVariable Long id, @Valid @RequestBody ProductV1 product) {
